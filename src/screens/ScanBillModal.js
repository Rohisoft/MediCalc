...
const s = StyleSheet.create({
  ...
  freePill:       { backgroundColor: '#f0fdf4', borderRadius: 20, paddingHorizontal: 16, paddingVertical: 7 },
  freePillText:   { fontSize: 11, color: '#16a34a', fontWeight: '500' },
  ...
  matchText:      { fontSize: 11, color: '#16a34a' },
